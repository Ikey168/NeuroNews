...
def demonstrate_full_pipeline():
    ...
    for test_case in test_articles:
        ...
        if result:
            ...
            print(f"   Source Credibility: {result.cleaned_data.get('source_credibility')}")
            ...
            if result.cleaned_data.get('validation_flags'):
                print(f"   🏁 Flags: {', '.join(result.cleaned_data['validation_flags'])}")
    ...
    print(f"{'Test Case':<30} {'Status':<10} {'Score':<8} {'Quality':<12} {'Credibility':<12}")
    print("-" * 80)
    ...
    for result_info in results:
        ...
        print(f"{result_info['name']:<30} {status:<10} {score:<8} {quality:<12} {credibility:<12}")
