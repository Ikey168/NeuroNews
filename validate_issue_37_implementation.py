...
def test_pydantic_models():
    ...
    try:
        ...
        try:
            ...
            print("✅ EntityRelationshipQuery validation correctly rejected invalid values")
...
async def test_mock_api_endpoints():
    ...
    try:
        ...
        from src.api.routes.enhanced_kg_routes import router, get_enhanced_graph_populator
        ...
        mock_populator = Mock()
        mock_populator.query_entity_relationships = AsyncMock(return_value={
            'query_entity': 'Google',
            'related_entities': [
                {
                    'id': 'entity_001',
        ...
        # Mock SPARQL query
        mock_populator.execute_sparql_query = AsyncMock(return_value={
...
def test_issue_37_requirements():
    ...
    try:
        ...
        from src.api.routes.enhanced_kg_routes import RelatedEntity, TimelineEvent
