...
from src.api.rbac.rbac_system import (
    RBACManager, UserRole, Permission, RolePermissionManager,
    DynamoDBPermissionStore, rbac_manager
)
...
class TestRBACManager:
    ...
    def test_get_role_summary(self):
        ...
        assert summary["admin"]["permission_count"] > summary["premium"]["permission_count"]
        assert summary["premium"]["permission_count"] > summary["free"]["permission_count"]
