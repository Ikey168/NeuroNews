...
import boto3
from moto import mock_dynamodb, mock_cloudwatch, mock_sns
...
from scraper.enhanced_retry_manager import EnhancedRetryManager, RetryConfig, RetryReason
...
class TestCloudWatchLogger:
    ...
    async def test_log_scraping_attempt(self):
        ...
        with patch.object(logger, '_send_log_entry') as mock_log, \
             patch.object(logger, '_send_cloudwatch_metrics') as mock_metrics:
...
class TestDynamoDBFailureManager:
    ...
    async def test_record_failure(self):
        ...
        with patch.object(manager.dynamodb, 'get_item') as mock_get, \
             patch.object(manager.dynamodb, 'put_item') as mock_put:
...
class TestIntegration:
    ...
    async def test_full_monitoring_workflow(self):
        ...
        # Mock AWS services
        with patch.object(cloudwatch_logger, 'log_scraping_attempt') as mock_log, \
             patch.object(failure_manager, 'record_failure') as mock_failure, \
...
if __name__ == "__main__":
    ...
    async def run_manual_tests():
        ...
        try:
            ...
            print(f"✅ Retry manager test passed: {result} (after {call_count} attempts)")
        except Exception as e:
