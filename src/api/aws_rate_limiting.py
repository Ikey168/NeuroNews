...
class APIGatewayManager:
    ...
    def __init__(self, region: str = None):
        ...
        try:
            ...
            self.usage_client = boto3.client('apigatewaymanagementapi', region_name=self.region)
    ...
    async def create_api_key_for_user(self, user_id: str, api_key_value: str) -> Optional[str]:
    ...
    async def get_usage_statistics(self, user_api_key: str, start_date: str, end_date: str) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                'total_requests': sum(response['values'].values()) if 'values' in response else 0,
    ...
    async def update_user_tier(self, user_id: str, old_tier: str, new_tier: str) -> bool:
...
class CloudWatchMetrics:
    ...
    async def put_rate_limit_metrics(self, user_id: str, tier: str, requests_count: int, violations: int):
    ...
    async def create_rate_limit_alarms(self):
        ...
        try:
            ...
            self.cloudwatch.put_metric_alarm(
                ...
                ActionsEnabled=True,
                AlarmActions=[
                    os.getenv('SNS_ALERT_TOPIC', 'arn:aws:sns:us-east-1:123456789012:neuronews-alerts')
                ],
