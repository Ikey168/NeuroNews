...
class DynamoDBPermissionStore:
    ...
    async def store_user_permissions(self, user_id: str, role: UserRole, 
...
class RBACManager:
    ...
    def _define_endpoint_permissions(self) -> Dict[str, Set[Permission]]:
        ...
        return {
            ...
            "GET /api/v1/knowledge-graph/related_entities": {Permission.READ_KNOWLEDGE_GRAPH},
            "GET /api/v1/knowledge-graph/event_timeline": {Permission.READ_KNOWLEDGE_GRAPH},
    ...
    async def get_user_role_from_db(self, user_id: str) -> Optional[UserRole]:
        ...
        if permissions and 'role' in permissions:
            try:
                ...
                logger.warning(f"Invalid role '{permissions['role']}' for user {user_id}")
        return None
