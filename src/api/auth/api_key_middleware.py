...
from src.api.auth.api_key_manager import api_key_manager, APIKeyStatus, APIKeyGenerator
    ...
    async def dispatch(self, request: Request, call_next):
        ...
        if api_key:
            ...
            if key_details:
                ...
                logger.info(f"API key authentication successful for user {key_details.user_id}")
