...
class FakeNewsDetector:
    ...
    def _predict_with_transformer(self, text: str) -> Dict[str, Any]:
        ...
        try:
            ...
            if isinstance(predictions[0], list):
                ...
                fake_score = scores.get('FAKE', scores.get('fake', scores.get('1', 0.5)))
                real_score = scores.get('REAL', scores.get('real', scores.get('0', 0.5)))
            ...
            return {
                ...
                "raw_scores": predictions[0] if isinstance(predictions[0], list) else predictions
            }
    ...
    def _predict_with_rules(self, title: str, content: str) -> Dict[str, Any]:
        ...
        fake_indicators = [
            "aliens", "miracle cure", "doctors hate", "secret trick",
            "shocking truth", "they don't want you to know",
            "click here", "you won't believe", "instant cure",
            "free money", "get rich quick", "amazing discovery"
        ]
        
        real_indicators = [
            "study shows", "research", "university", "published",
            "according to", "expert", "analysis", "data",
            "statistics", "peer-reviewed", "journal", "scientist"
        ]
    ...
    def _generate_explanation(self, 
        ...
        if is_real:
            ...
            if any(word in (title + content).lower() for word in ["miracle", "shocking", "secret"]):
                ...
                base_explanation += ". Content lacks credible sources or contains questionable claims"
