...
def build_sample_graph():
    ...
    try:
        ...
        article_props = {
            ...
            "tags": ["artificial intelligence", "technology", "safety", "collaboration"]
        }
        ...
        sponsors = graph.g.V().hasLabel("Event").has("eventName", "Global AI Safety Summit 2025")\
            .in_("SPONSORED").valueMap().toList()
        print(json.dumps(sponsors, indent=2))
        
        # Find collaboration network
        print("\n3. Organization collaboration network:")
        collabs = graph.g.V().hasLabel("Organization")\
            .out("PARTNERS_WITH").path().by("orgName").toList()
