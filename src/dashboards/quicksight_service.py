        ...
        try:
            ...
            for dataset_id in datasets:
                try:
                    ...
                    validation_results["errors"].append(
                        f"Dataset {dataset_id} validation failed: {e}"
                    )
            ...
            for analysis_id in analyses:
                try:
                    ...
                    validation_results["errors"].append(
                        f"Analysis {analysis_id} validation failed: {e}"
                    )
            ...
            for dashboard_id in dashboards:
                try:
                    ...
                    validation_results["errors"].append(
                        f"Dashboard {dashboard_id} validation failed: {e}"
                    )
            ...
            logger.info(
                f"Validation completed: {'Success' if validation_results['overall_valid'] else 'Issues found'}"
            )
...
async def demo_quicksight_dashboard_service():
    ...
    try:
        ...
        print(
            f"Overall validation: {'✅' if validation_result['overall_valid'] else '❌'}"
        )
