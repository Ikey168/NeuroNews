...
class ReutersSpider(scrapy.Spider):
    ...
    def parse_article(self, response):
        ...
        # Extract title
        item['title'] = (
            response.css('h1[data-testid="Heading"]::text').get() or
            response.css('h1.ArticleHeader_headline::text').get() or
        ...
        # Extract content
        content_paragraphs = (
            response.css('div[data-testid="paragraph"] p::text').getall() or
            response.css('.StandardArticleBody_body p::text').getall() or
        ...
        date_element = (
            ...
            response.css('span[data-testid="Body"] time::attr(datetime)').get() or
        ...
        # Extract author
        author = (
            response.css('div[data-testid="BylineBar"] a::text').get() or
