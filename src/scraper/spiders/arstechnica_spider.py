...
class ArsTechnicaSpider(scrapy.Spider):
    ...
    def parse_article(self, response):
        ...
        item["title"] = (
            ...
            or response.css('h1[itemprop="headline"]::text').get()
        ...
        content_paragraphs = (
            ...
            or response.css('div[itemprop="articleBody"] p::text').getall()
        ...
        date_element = (
            ...
            or response.css(".post-meta time::attr(datetime)").get()
            or response.css(
        ...
        # Extract author
        author = (
            response.css('span[itemprop="author"] a::text').get()
