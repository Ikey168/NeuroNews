...
class WiredSpider(scrapy.Spider):
    ...
    def parse_article(self, response):
        ...
        # Extract title
        item['title'] = (
            response.css('h1[data-testid="ContentHeaderHed"]::text').get() or
            response.css('h1.content-header__hed::text').get() or
        ...
        # Extract content
        content_paragraphs = (
            response.css('div[data-testid="ArticleBodyWrapper"] p::text').getall() or
            response.css('.article__body p::text').getall() or
        ...
        date_element = (
            response.css('time[data-testid="ContentHeaderPublishDate"]::attr(datetime)').get() or
        ...
        # Extract author
        author = (
            response.css('a[data-testid="ContentHeaderAuthorLink"]::text').get() or
