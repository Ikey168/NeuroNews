...
class NPRSpider(scrapy.Spider):
    ...
    def parse_article(self, response):
        ...
        # Extract title
        item["title"] = (
            response.css("h1.storytitle::text").get()
            or response.css("h1.story-title::text").get()
        ...
        # Extract content
        content_paragraphs = (
            response.css("#storytext p::text").getall()
            or response.css(".storytext p::text").getall()
        ...
        date_element = (
            response.css(".dateblock time::attr(datetime)").get()
        ...
        # Extract author
        author = (
            response.css(".byline__name a::text").get()
