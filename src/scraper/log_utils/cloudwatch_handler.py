...
class CloudWatchLoggingHandler(logging.Handler):
    ...
    def __init__(self, log_group_name, log_stream_name=None, aws_access_key_id=None, 
        ...
        self.log_stream_name = log_stream_name or f"scraper-{datetime.now().strftime('%Y%m%d-%H%M%S')}"
