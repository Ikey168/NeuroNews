...
def test_pipelines():
    ...
    try:
        ...
        pipeline_classes = ['ValidationPipeline', 'DuplicateFilterPipeline', 'EnhancedJsonWriterPipeline']
        found_classes = []
        ...
        if len(found_classes) == len(pipeline_classes):
            ...
            print(f"❌ Missing pipeline classes: {set(pipeline_classes) - set(found_classes)}")
            return False
