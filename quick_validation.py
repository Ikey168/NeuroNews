...
def test_basic_functionality():
    ...
    try:
        ...
        print(f"✅ Created optimization config: {config.max_concurrent_tasks} concurrent tasks")
        ...
        async def test_processing():
            try:
                ...
                return {
                    ...
                    'throughput': len(results.get('processed_articles', [])) / processing_time if processing_time > 0 else 0
                }
...
def main():
    ...
    if success:
        ...
        print("\nNext steps:")
        print("1. Run full test suite: python -m pytest tests/test_optimized_pipeline.py")
