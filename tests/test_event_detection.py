...
class TestArticleEmbedder:
    ...
    def test_embedding_quality_calculation(self, embedder):
        ...
        good_score = embedder._calculate_embedding_quality(good_embedding, "Good quality text with sufficient length")
...
class TestEventDetectionAPI:
    ...
    def mock_clusterer(self):
        ...
        clusterer = Mock()
        clusterer.get_breaking_news = AsyncMock(return_value=[
            {
