...
class TestS3ArticleStorage:
    ...
    @patch('boto3.client')
    def test_generate_s3_key_raw_article(self, mock_boto3, s3_config, mock_s3_client, sample_article):
    ...
    @patch('boto3.client')
    def test_generate_s3_key_processed_article(self, mock_boto3, s3_config, mock_s3_client, sample_article):
    ...
    @patch('boto3.client')
    async def test_store_raw_article_success(self, mock_boto3, s3_config, mock_s3_client, sample_article):
    ...
    @patch('boto3.client')
    async def test_store_raw_article_missing_fields(self, mock_boto3, s3_config, mock_s3_client):
    ...
    @patch('boto3.client')
    async def test_store_processed_article_success(self, mock_boto3, s3_config, mock_s3_client, sample_article):
        ...
        metadata = await storage.store_processed_article(sample_article, processing_metadata)
    ...
    @patch('boto3.client')
    async def test_retrieve_article_success(self, mock_boto3, s3_config, mock_s3_client):
    ...
    @patch('boto3.client')
    async def test_verify_article_integrity_success(self, mock_boto3, s3_config, mock_s3_client):
    ...
    @patch('boto3.client')
    async def test_verify_article_integrity_failure(self, mock_boto3, s3_config, mock_s3_client):
    ...
    @patch('boto3.client')
    async def test_batch_store_raw_articles(self, mock_boto3, s3_config, mock_s3_client):
    ...
    async def test_s3_client_unavailable(self, mock_boto3, s3_config):
        ...
        with pytest.raises(ValueError, match="S3 client not available"):
            await storage.store_raw_article({"title": "test", "content": "test", "url": "test"})
...
class TestS3IngestionFunctions:
    ...
    async def test_ingest_scraped_articles_success(self, mock_storage_class, s3_config, sample_articles):
    ...
    @patch('src.database.s3_storage.S3ArticleStorage')
    async def test_verify_s3_data_consistency_success(self, mock_storage_class, s3_config):
    ...
    @patch('src.database.s3_storage.S3ArticleStorage')
    async def test_verify_s3_data_consistency_with_failures(self, mock_storage_class, s3_config):
