...
class TestRedshiftETLProcessor(unittest.TestCase):
    ...
    def test_context_manager(self):
        ...
        with patch.object(self.processor, 'connect') as mock_connect, \
             patch.object(self.processor, 'close') as mock_close:
...
class TestRedshiftIntegration(unittest.TestCase):
    ...
    def test_validation_to_redshift_flow(self):
        ...
        self.mock_processor.process_validation_pipeline_output.assert_called_once_with(validation_results)
