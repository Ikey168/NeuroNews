...
class TestFakeNewsDetector:
    ...
    def test_training(self, mock_training_args, mock_trainer, detector, sample_texts, sample_labels):
        """Test model training."""
        # Setup mocks
    ...
    def test_predict_trustworthiness(self, mock_no_grad, detector):
        ...
        # Mock model output
        mock_logits = Mock()
        mock_logits.cpu.return_value.numpy.return_value = [[0.2, 0.8]]  # High confidence for "real"
